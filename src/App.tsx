...
export default function App() {
  ...
  return (
    <div className={`min-h-screen bg-[#FAF9F6] dark:bg-[#121211] text-[#1C1C1A] dark:text-[#F5F4F0] flex flex-col font-sans antialiased relative transition-colors duration-300 ${currentView === 'workspace' || currentView === 'intake' ? 'lg:h-screen lg:overflow-hidden' : 'overflow-x-hidden'}`}>
      ...
      {/* Main Container */}
      <main className={`flex-1 max-w-[1680px] w-full mx-auto px-4 sm:px-6 md:px-8 lg:px-10 pt-20 md:pt-24 relative z-10 ${currentView === 'workspace' || currentView === 'intake' ? 'pb-4 lg:pb-3 h-auto lg:h-[calc(100vh-1rem)] lg:overflow-hidden flex flex-col justify-center' : 'pb-16 flex flex-col justify-center'}`}>
